...
class EvolveNGPU : public Evolve {
 public:
  EvolveNGPU(float *ni, int *pt, Parameters *params)
 ...
 protected:
  ...
  // Buffers for surface normals and anchoring strength on the GPU.
  float *d_ns_buf = 0;
  float *d_W_buf  = 0;
};

// Subclasses only declare what is different from EvolveNGPU.
// Nx, Ny, Nz, ni, pt are inherited — no redeclaration needed.
